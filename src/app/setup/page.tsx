      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 py-16">
        ...
        <section className="rounded-xl border border-slate-700 bg-slate-900/60 p-6">
          ...
          <div className="flex flex-col gap-3">
            <Link
              href="/"
              className="inline-flex items-center gap-2 rounded-lg border border-slate-600 bg-slate-800 px-4 py-3 text-slate-200 transition hover:border-slate-400 hover:bg-slate-700"
            >
              <span className="text-lg">🎵</span>
              <div>
                <p className="font-medium">콘서트 예매 시스템</p>
                <p className="text-sm text-slate-400">메인 페이지 - 콘서트 목록 조회 (유저플로우 #1)</p>
              </div>
            </Link>
          </div>
        </section>
