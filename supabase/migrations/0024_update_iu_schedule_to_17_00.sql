-- Migration: Update IU Concert 2025 schedules to 17:00 KST (UTC 08:00)
-- 아이유 콘서트 2025의 모든 공연 회차를 오후 5시(17:00)로 변경

BEGIN;

-- 아이유 콘서트 2025 시간을 UTC 08:00으로 변경 (= KST 17:00)
...
BEGIN
  ...
  WHERE c.title = '아이유 콘서트 2025';
  
  RAISE NOTICE '아이유 콘서트 2025 스케줄 업데이트 완료: % 개 회차', updated_count;
